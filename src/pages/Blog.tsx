  ...
  return (
    <PageLayout>
      <PageHero
        ...
        subtitle="Practical web design, SEO, branding, and technology guidance to help your business grow online."
        image="/images/blog-covers.jpg"
        imageAlt="A collection of Arlotech editorial stories about business, design, SEO, performance, and AI"
      ...
      {featured && activeCategory === "All" && !search && (
        <section className="mx-auto max-w-7xl px-6 pb-12">
          <Link
            ...
            className="group block overflow-hidden rounded-3xl border border-border/30 bg-[#172033] shadow-xl transition hover:-translate-y-1 hover:border-emerald-500/30"
          >
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {filtered.map((post) => (
              <Link
                key={post.slug}
                to={`/blog/${post.slug}`}
                className="group overflow-hidden rounded-2xl border border-border/30 bg-[#172033] shadow-lg transition hover:-translate-y-1 hover:border-emerald-500/30 hover:shadow-emerald-500/5"
              >
                {/* Cover */}
      ...
      {/* Newsletter */}
      <section className="mx-auto max-w-7xl px-6 pb-20">
        <div className="rounded-3xl border border-emerald-500/20 bg-[#172033] p-10 md:p-14 text-center">
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="relative overflow-hidden rounded-3xl border border-emerald-500/20 p-12 text-center">
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-base text-muted-foreground max-w-lg mx-auto">
              Whether you need a website, branding, SEO, or digital solutions, Arlotech is here to help your
              business grow.
            </p>
