  ...
  return (
    <PageLayout>
      <PageHero
        ...
        imageAlt="A secure web engineering workspace"
      />
      ...
      <Section className="space-y-12">
        <div className="glass rounded-4xl border border-border/40 p-10 shadow-panel">
          ...
          <p className="mt-4 text-sm leading-7 text-muted-foreground">
            This policy applies to personal information collected through the Arlotech website, including
            contact forms, briefing submissions, and inquiry messages submitted via the site.
          </p>
        </div>
        ...
        <div className="glass rounded-4xl border border-border/40 p-10 shadow-panel">
          ...
          <p className="mt-4 text-sm leading-7 text-muted-foreground">
            We may collect contact details, project briefing information, and optional business metrics to
            scope proposals and deliver premium solutions.
          </p>
        </div>
        ...
        <div className="glass rounded-4xl border border-border/40 p-10 shadow-panel">
          ...
          <p className="mt-4 text-sm leading-7 text-muted-foreground">
            We protect data with industry-standard controls, encrypt communication, and retain information
            only for as long as necessary to support project work and client relationships.
          </p>
        </div>
      </Section>
    </PageLayout>
