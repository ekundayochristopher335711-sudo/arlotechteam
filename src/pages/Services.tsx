...
const process = [
  {
    ...
    description: "We start with a free call to understand your project and goals.",
  },
  ...
  return (
    <PageLayout>
      <PageHero
        ...
        imageAlt="A website designer refining a business website alongside the code"
      />
      ...
      <section className="bg-[#eef5f0] py-20">
        <div className="mx-auto max-w-7xl px-6">
          <div className="text-center mb-14">
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-bold text-[#111]">
              Our Services, Built Around You
            </h2>
            <p className="mt-4 text-base text-[#555] max-w-2xl mx-auto">
              From idea to launch and beyond, we provide end-to-end digital solutions tailored to your
              business goals.
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-4">
            {services.map((service) => (
              ...
              >
                ...
                {/* Title */}
                <h3 className="mt-5 text-[15px] font-bold text-[#111] leading-snug">{service.title}</h3>

                {/* Description */}
                <p className="mt-3 text-sm leading-6 text-[#666]">{service.summary}</p>
        ...
        <div className="relative overflow-hidden rounded-3xl border border-emerald-500/20 p-12 text-center shadow-panel">
          ...
          <div className="relative">
            ...
            <p className="mt-4 text-base leading-7 text-muted-foreground max-w-lg mx-auto">
              Book a free call and we'll help you figure out exactly what you need — no sales pitch, just
              honest advice.
            </p>
            <div className="mt-8">
              <Link
